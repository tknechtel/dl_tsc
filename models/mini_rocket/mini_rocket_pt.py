...
import numpy as np
import pandas as pd
from .base.base_rocket_tf import Base_Classifier_ROCKET_TF
from utils.utils import calculate_metrics


class Classifier_ROCKET_TF():
    ...
    def fit(self, x_train, y_train, x_test, y_test, y_true):
        ...
        rocket = Base_Classifier_ROCKET_TF(self.n_kernels, self.kss, self.verbose)
